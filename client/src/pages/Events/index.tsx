          ...
          <div className="flex flex-col md:flex-row gap-4 bg-white p-4 rounded-xl shadow-md">
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-10 h-12 border-gray-300 focus:border-purple-600"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="h-12 px-4 border border-gray-300 rounded-lg focus:border-purple-600 focus:ring-purple-600"
              >
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              {authUser ? (
                ...
                <div className="py-8 text-center">
                  <p className="text-gray-600">Vous devez être connecté pour effectuer cette action.</p>
                </div>
              )}
            </DialogContent>
          </Dialog>
