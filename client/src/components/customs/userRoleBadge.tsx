import { User2, ShieldCheck, ShieldQuestion, Users2 } from "lucide-react";
...
const defaultRoles: Record<string, { icon: JSX.Element; color: string }> = {
  ...
  organizer: { icon: <Users2 size={16} />, color: "text-green-500" },
  user: { icon: <User2 size={16} />, color: "text-blue-500" },
};

export const UserRoleBadge = ({ role }: { role: "admin" | "organizer" | "user" }) => {
